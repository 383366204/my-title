---
name: ecom-ai-tools
description: 电商选品AI工具箱。当用户需要生成淘宝/1688 商品标题、做电商 SEO 优化、根据关键词生成商品标题、查同行标题、做电商选品、查看1688商机热榜、趋势分析、查生意参谋数据时使用。基于 GLM AI 提取核心词 + 1688 实时搜索 + 同行标题参考，输出三段式 SEO 优化标题。
---
