...
const { assessInspiration, assessRootCandidate } = require('../../../../skills/keyword-mining/src/inspiration-guard');
const { collectInspirations, parseFeedItems } = require('../../../../skills/keyword-mining/src/inspiration-sources');
