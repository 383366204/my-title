...
} = require('../../../../skills/sycm-research/src/product-rank');
const {
  averagePayment,
  fetchImage,
  generateOrderSheet,
  imageUrlCandidates,
  normalizeImageUrl
} = require('../../../../skills/order-sheet/src/generate-order-sheet');
...
describe('order sheet workflow', () => {
  ...
  it('merges rank items and manual items with deduplication and field overrides', () => {
    const { mergeOrderSheetProducts } = require('../../../../skills/order-sheet/index');
    const rankRows = [
  ...
  it('saves missing manual product titles before sheet generation resumes', async () => {
    const { collectOrderSheetProducts, updateOrderSheetManualProducts } = require('../../../../skills/order-sheet/index');
    const { getRun, readJsonl } = require('../../../../skills/pipeline-flow/src/run-store');
  ...
  it('restores static product fields when the client sends a trimmed draft payload', async () => {
    const {
      ...
      saveOrderSheetDraft,
      getOrderSheetDraft
    } = require('../../../../skills/order-sheet/index');
